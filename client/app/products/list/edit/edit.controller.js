/**
 * @ngdoc controller
 * @name catalogAppproduct.list.edit.controller:ProductEditController
 * @description
...
(function () {
	...
	angular
		.module('catalogApp.product.list.edit')
		.controller('ProductEditController', ProductEditController);

	/**
	 * @ngdoc function
	 * @name catalogAppproduct.list.edit.provider:ProductEditController
	 * @description
	 * Provider of the {@link catalogAppproduct.list.edit.controller:ProductEditController ProductEditController}
