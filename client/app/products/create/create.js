(function () {
	...
	/**
	 * Introduce the catalogApp.product.create module
	 * and configure it.
	 *
	 * @requires ui.router
	 * @requires ngMessages
	 * @requires ngMaterial
	 * @requires {catalogApp.mongooseError}
	 * @requires {catalogApp.remoteUnique}
	 * @requires {catalogApp.product.service}
	 */
