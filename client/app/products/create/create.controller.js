/**
 * @ngdoc controller
 * @name catalogApp.product.create.controller:ProductCreateController
 * @description
...
(function () {
	...
	angular
		.module('catalogApp.product.create')
		.controller('ProductCreateController', ProductCreateController);

	/**
	 * @ngdoc function
	 * @name catalogApp.product.create.provider:ProductCreateController
	 * @description
	 * Provider of the {@link catalogApp.product.create.controller:ProductCreateController ProductCreateController}
	 *
	 ...
	 * @returns {Service} {@link catalogApp.product.create.controller:ProductCreateController ProductCreateController}
	 */
	...
	function ProductCreateController($mdDialog, Product, ProductService, Toast) {
		 ...
		 * @ngdoc property
		 * @name product
		 * @propertyOf catalogApp.product.create.controller:ProductCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name createProduct
		 * @methodOf catalogApp.product.create.controller:ProductCreateController
		 * @description
