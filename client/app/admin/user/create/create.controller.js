/**
 * @ngdoc controller
 * @name testAppApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('catalogApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name testAppApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link testAppApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link testAppApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf testAppApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf testAppApp.admin.user.create.controller:UserCreateController
		 * @description
