/**
 * @ngdoc overview
 * @name testAppApp.admin.user.create
 * @description
 * The `testAppApp.admin.user.create` module which provides
 *
 * - {@link testAppApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
	...
	angular
		.module('catalogApp.admin.user.create', [
			...
			'catalogApp.auth',
			'catalogApp.toast',
			'catalogApp.remoteUnique',
			'catalogApp.mongooseError'
		])
