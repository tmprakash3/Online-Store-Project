/**
 * @ngdoc controller
 * @name testAppApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name testAppApp.admin.user.list.items.provider:UserItemsController
	 * @description
	 * Provider of the {@link testAppApp.admin.user.list.items.controller:UserItemsController UserItemsController}
	 *
	 */
	...
	function UserItemsController($state, Auth) {
		 ...
		 * @ngdoc function
		 * @name isSelected
		 * @methodOf testAppApp.admin.user.list.items.controller:UserItemsController
		 * @description
