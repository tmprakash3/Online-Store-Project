/**
 * @ngdoc controller
 * @name testAppApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
	...
	angular
		.module('catalogApp.admin.user.list.edit')
		.controller('EditPasswordController', EditPasswordController);


	/**
	 * @ngdoc function
	 * @name testAppApp.admin.user.list.edit.provider:EditPasswordController
	 * @description
	 * Provider of the {@link testAppApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 *
	 ...
	 * @returns {Service} {@link testAppApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 */
	...
	function EditPasswordController($mdDialog, UserService, user, Toast) {
		 ...
		 * @ngdoc function
		 * @name changePassword
		 * @methodOf testAppApp.admin.user.list.edit.controller:EditPasswordController
		 * @description
