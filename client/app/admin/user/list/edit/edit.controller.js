/**
 * @ngdoc controller
 * @name testAppApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name testAppApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link testAppApp.admin.user.list.edit.controller:UserEditController UserEditController}
