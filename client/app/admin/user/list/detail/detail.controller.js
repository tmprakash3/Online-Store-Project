/**
 * @ngdoc controller
 * @name testAppApp.admin.user.list.detail.controller:UserDetailController
 * @description
...
(function () {
	 ...
	 */
	angular
		.module('catalogApp.admin.user.list.detail')
		.controller('UserDetailController', UserDetailController);

	/**
	 * @ngdoc function
	 * @name testAppApp.admin.user.list.detail.provider:UserDetailController
	 * @description
	 * Provider of the {@link testAppApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
	 *
	 ...
	 * @returns {Service} {@link testAppApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
	 */
	...
	function UserDetailController($state, user, Auth) {
		 ...
		 * @ngdoc property
		 * @name user
		 * @propertyOf testAppApp.admin.user.list.detail.controller:UserDetailController
		 * @description
		 ...
		 * @ngdoc function
		 * @name edit
		 * @methodOf testAppApp.admin.user.list.detail.controller:UserDetailController
		 * @description
