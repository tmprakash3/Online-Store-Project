/**
 * @ngdoc overview
 * @name testAppApp.admin.user.list.detail
 * @description
 * The `testAppApp.admin.user.list.detail` module which provides:
 *
 * - {@link testAppApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires testAppApp.auth.user
 */
(function () {
	'use strict';
