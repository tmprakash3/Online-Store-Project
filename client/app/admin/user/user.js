(function () {
	...
	/**
	 * Introduce the testAppApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {testAppApp.admin.user.list}
	 * @requires {testAppApp.admin.user.create}
	 */
	angular
		.module('catalogApp.admin.user', [
			'ngResource',
			'ui.router',
			'catalogApp.admin.user.list',
			'catalogApp.admin.user.create'
		])
